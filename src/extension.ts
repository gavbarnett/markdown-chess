...
function generateBoard(boardGrid: [string[]])
{
	...
	`/> `;
	//Add chess pieces
	returnHtml += `<symbol id="chesswhiteking" width="100" height ="100">
	...
	returnHtml += `<symbol id="chesswhitequeen" width="100" height ="100">
	...
	returnHtml += `<symbol id="chesswhiterook" width="100" height ="100">
	...
	returnHtml += `<symbol id="chesswhitebishop" width="100" height ="100">
	...
	returnHtml += `<symbol id="chesswhiteknight" width="100" height ="100">
	...
	returnHtml += `<symbol id="chesswhitepawn" width="100" height ="100">
	...
	returnHtml +=`<use x="400" y="750" 	xlink:href="#chesswhiteking"/>`;
	returnHtml +=`<use x="500" y="750" 	xlink:href="#chesswhitequeen"/>`;
