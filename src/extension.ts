...
function generateBoard(boardGrid: [string[]])
{
	...
	`<rect `+
		`x="` + gridSize.toString() + `" y="` + (gridSize/2).toString() + `" `+
		`width="` + (gridSize*boardWidth).toString() + `" `+
		`height="` + (gridSize*boardHeight).toString() + `" `+
		`fill="OliveDrab"`+
	`/> `;
	returnHtml += definedChessMaterial();
...
function definedChessMaterial()
{
	var chessSvgSymbols: string = "";
		...
		//White Pieces
		chessSvgSymbols += `<symbol id="chesswhiteking" width="100" height ="100">
		...
		chessSvgSymbols += `<symbol id="chesswhitequeen" width="100" height ="100">
		<g transform="scale(2.22)" style="fill:#ffffff;stroke:#000000;stroke-width:1.5;stroke-linejoin:round">
		...
		chessSvgSymbols += `<symbol id="chesswhiterook" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.3)">
		<path
		...
		chessSvgSymbols += `<symbol id="chesswhitebishop" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.6)">>
		...
		chessSvgSymbols += `<symbol id="chesswhiteknight" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.3)">
		<path
		...
		chessSvgSymbols += `<symbol id="chesswhitepawn" width="100" height ="100">
		...
		//Black Pieces
		chessSvgSymbols += `<symbol id="chessblackking" width="100" height ="100">
		<g transform="scale(2.22)" style="fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;">
		...
		chessSvgSymbols += `<symbol id="chessblackqueen" width="100" height ="100">
		<g transform="scale(2.22)" style="fill:#000000;stroke:#000000;stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round">
			<path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z"
		...
		chessSvgSymbols += `<symbol id="chessblackrook" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:#000000; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.3)">
			<path
				d="M 9,39 L 36,39 L 36,36 L 9,36 L 9,39 z "
				style="stroke-linecap:butt;" />
			<path
		...
		chessSvgSymbols += `<symbol id="chessblackbishop" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.6)">
		...
		chessSvgSymbols += `<symbol id="chessblackknight" width="100" height ="100">
		<g transform="scale(2.22)" style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.3)">
			<path
				d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18"
				style="fill:#000000; stroke:#000000;" />
		...
		chessSvgSymbols += `<symbol id="chessblackpawn" width="100" height ="100">
		<g transform="scale(2.22)">
		<path 
			d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z" 
			style="opacity:1; 
